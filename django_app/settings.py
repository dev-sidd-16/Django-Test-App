...
DATABASES = {
    'default': {
        ...
        'NAME': 'files.db',                      # Or path to database file if using sqlite3.
...
MEDIA_ROOT = '/home/siddhant/Documents/IIIT-H/Coding/Django tutes/django_app/static/'
...
SECRET_KEY = 'rp91&n+m0_mdyphe-mjmll8#()=+y1&g^a=h(032#6#7w(#zo_'
